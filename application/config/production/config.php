...
/*
  ...
  |
 */
$config['encryption_key'] = '68fba64d78c471e691f049208a72104e';
...
/*
  ...
  |
 */
$config['sess_cookie_name'] = 'lynx_sess';
$config['sess_expiration'] = 60 * 60 * 2; //7200
...
$config['csrf_token_name'] = 'lynx_token';
$config['csrf_cookie_name'] = 'lynx';
...
/*
  |--------------------------------------------------------------------------
  | Lynx Original Configurations
  |--------------------------------------------------------------------------
 */


$config['portal_login_url'] = 'http://dento.vn/login?cp={cp}';
$config ['reset_password'] = 'http://dento.vn/reset_password?u={user}&p={password}';
...
$config['calendar_beginning_year_month'] = '201307';
$config['calendar_month_diff_from'] = -6;
$config['calendar_month_diff_to'] = +6;

$config['languagePath'] = 'language/';
$config['languages_supported'] = array('VN-VI', 'EN-US', 'KO-KR');

$config['facebook_app_id'] = '702763973125256';
