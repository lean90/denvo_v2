<div class="profile-box profile-box-add form-horizontal"
	...
	<div class="form-group col-md-10">
		...
		<div class="col-sm-8">
			<input id="txtFullName{{history.id}}"
	...
	<div class="form-group col-md-10">
		...
		<div class="col-sm-8">
			<input id="txtDob{{history.id}}" ng-model="selectedHistory.dob"
	...
	<div class="form-group col-md-10">
		<label for="inputEmail3" class="col-sm-4 control-label text-left">Ngày
			khám gần nhất</label>
		<div class="col-sm-8">
			<input id="txtExamination{{history.id}}"
	...
	<div class="form-group col-md-10">
		...
		<div class="col-sm-8" ng-click="debug()">
	...
	<div class="form-group col-md-10">
		<label for="inputEmail3" class="col-sm-4 control-label text-left">Email<span
			style="color: red">(*)</span></label>
		<div class="col-sm-8">
			<input id="email{{history.id}}" ng-model="selectedHistory.email"
	...
	<div class="col-md-12 profile-title-higlight">
		...
		<div class="form-group col-md-10">
			...
			<div class="col-sm-6">
				<input id="txtAmount{{history.id}}"
					ng-model="selectedHistory.teeth_status.amount" type="text" required
					aria-required="true" class="form-control"
	...
	<div class="col-md-12 " style="margin-top: 15px">
		...
		<div class="schema-conatiner">
			...
			<div class="schema-description">
				<div ng-click="openToolTip('description-edit-1')" class="profile-title-higlight"> <span class="profile-title-higlight">Sơ đồ răng sữa</span> <i class="fa fa-question-circle profile-title-higlight"></i></div>
	...
	<div class="col-md-12" style="margin-top: 15px;">
		...
		<div class="col-md-12" style="margin-left: 50px;">
			<div class="checkbox col-sm-4">
				<label><input ng-model="selectedHistory.teeth_status.feed"
					name="overview-teeth-status-{{history.id}}" type="radio"
					value="GOOD" class="simple"> Tốt</label>
			</div>
			<div class="checkbox col-sm-4">
				<label><input ng-model="selectedHistory.teeth_status.feed"
					name="overview-teeth-status-{{history.id}}" type="radio"
					value="NOTGOOD" class="simple"> Chưa tốt, có vấn đề</label>
			</div>
		</div>
	</div>
	<div class="col-md-12" style="margin: 15px 0px;">
		<a href="javascript:void(0);" ng-click="save(true)" style="width: 540px" class="btn btn-primary col-md-12"> 
			<i class="glyphicon glyphicon-plus-sign"></i>
			&nbsp; Lưu lại
		</a> 
		<br/><br/>
		<a href="javascript:void(0);" ng-click="saveAndSend(true)" style="width: 540px" class="btn btn-primary col-md-12"> 
...
<!-- Modal -->
<div class="modal fade" id="profile-detail-modal-edit"
	...
	<div class="modal-dialog">
		<div class="modal-content"
			...
			<div class="modal-footer"
				...
				<button ng-click="mergeDetail(true)" type="button" class="btn btn-primary">Lưu thay đổi</button>
