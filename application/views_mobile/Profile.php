...
<div class="body-content width-960" ng-controller="ProfileController">
	<form id="profile-support-frm"
		action="/profile/<?php echo $userid?>/ho-so-rang-mieng/send_support"
		novalidate method="post" enctype="multipart/form-data">
		<input name="data" type="hidden" value="{{getPostDataForSupport()}}" />
	</form>

	<form id="profile-support-response-frm"
		action="/profile/<?php echo $userid?>/ho-so-rang-mieng/response_support"
		novalidate method="post" enctype="multipart/form-data">
		<input name="data" type="hidden" value="{{getSupportFrmData()}}" />
	</form>


	<form id="profile-frm" name="profile_frm" method="post" enctype="multipart/form-data">

		<input name="data" type="hidden" value="{{getPostData()}}" /> 
		<input name="send" type="hidden" ng-model="isSendEmail" />
		<div class="detail-view post-view width-960">
			<div class="left">
				...
				<a href="#" ng-click="showCreateFrm()" class="btn btn-primary"
                    ...
                    <?php include APPPATH.'views/ProfileNew.php'; ?>
...
<script type="text/ng-template" id="view.html">
    <?php include APPPATH.'views/ProfileDetail.php'; ?>
</script>
<script type="text/ng-template" id="edit.html">
    <?php include APPPATH.'views/ProfileEdit.php'; ?>
</script>
