    ...
    <div style="margin-bottom: 100px" ng-controller="PositionController" class="location-container">
        <div class="filter-on-map">
            <select class="form-control" ng-model="selectedFilterByName" style="width: 230px; float: left;">
                        ...
                        <table>
                            <tr>
                                ...
                                <td><a ng-href="/ban-do/{{position.id}}"><h4>{{position.name}}</h4></a>
                                	<div class="detail-address like-number" ng-show="listState == 'by-like-number'" style="width:100%">
                                    	<table>
						            		<tr>
