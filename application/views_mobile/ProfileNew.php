...
<div class="profile-box profile-box-add form-horizontal"
	...
	<span ng-click="showCreateFrm()" class="close-btn"><i class="fa fa-times-circle"></i></span>
	<div class="form-group col-md-10" style="margin-top:40px;">
	...
	<div class="form-group col-md-10">
		...
		<div class="col-sm-8">
			<input id="email-add" ng-model="createNewProfile.email" type="email"
				...
				placeholder="Nhập email" data-rule-required="true">
		</div>
	</div>
	...
	<div class="col-md-12 " style="margin-top: 15px">
		...
		<div class="schema-conatiner">
			...
			<div class="schema-description">
				<div ng-click="openToolTip('description-new-1')" class="profile-title-higlight"> <span class="profile-title-higlight">Sơ đồ răng sữa</span> <i class="fa fa-question-circle profile-title-higlight"></i></div>
	...
	<div class="col-md-12 text-center" style="margin: 15px 0px;">
		<a href="javascript:void(0);" ng-click="save()" style="width: 540px" class="btn btn-primary col-md-12"> <i class="glyphicon glyphicon-plus-sign"></i>
			&nbsp; Lưu lại
		</a> 
		<br/><br/>
		<a href="javascript:void(0);" ng-click="saveAndSend()" style="width: 540px" class="btn btn-primary col-md-12" > <i class="glyphicon glyphicon-send"></i>
