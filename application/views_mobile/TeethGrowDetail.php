<div class="profile-box profile-box-add form-horizontal" style="width:100%;border: none; padding: 0px; margin: 0px;">
    ...
    <div class="col-md-12 " style="margin-top: 15px" ng-show="getDisplayTimelineTableData(selectedHistory.history,'RS').length != 0">
        <div class="schema-conatiner">
            ...
            <div class="schema-description">
                <div ng-click="openToolTip('description-detail-1')" class="profile-title-higlight">
                    <span class="profile-title-higlight">Sơ đồ răng sữa</span> <i class="fa fa-question-circle profile-title-higlight"></i>
                </div>
    ...
    <div class="col-md-12 " style="margin-top: 15px" ng-show="getDisplayTimelineTableData(selectedHistory.history,'RVV').length != 0">
        <div class="schema-conatiner">
            ...
            <div class="schema-description">
                <div ng-click="openToolTip('description-detail-2')" class="profile-title-higlight">
                    <span class="profile-title-higlight">Sơ đồ răng vĩnh viễn</span> <i class="fa fa-question-circle profile-title-higlight"></i>
                </div>
    ...
    <div class="col-md-12 text-center" style="margin: 15px 0px;" ng-show='me.id == selectedHistory.user_id'>
        <a href="javascript:void(0);" ng-click="enableEditProfile()" class="btn btn-primary"> <i class="glyphicon glyphicon-edit"></i> &nbsp; Chỉnh sửa</a> 
        ...
        <br /> <br /><a ng-href="/profile/{{me.id}}/ho-so-rang-mieng/{{selectedHistory.id}}/del"  class="btn btn-danger"> <i class="glyphicon glyphicon-floppy-remove" style="color: white"></i> &nbsp; Xóa</a>
    </div>
</div>