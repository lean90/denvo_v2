...
<div class="region news col-xs-12 text-center">
	<div class="region-content text-center">
		<div class="blocks">
			...
			<a class="sea-blue block" href="/tin-tuc/kien-thuc-chung-ve-rang-mieng">Kiến thức <br/> về răng miệng</a>
			<a class="red block" href="/tin-tuc/theo-doi-cham-soc-rang-mieng-theo-lua-tuoi">Theo dõi <br/> chăm sóc <br/> răng miệng <br/> theo lứa tuổi</a>
			<a class="blue block" href="/tin-tuc/che-do-dinh-duong-ve-sinh-rang-mieng"> Chế độ <br/> dinh dưỡng, <br/> vệ sinh <br/> răng miệng</a> 
			<a class="yellow block" href="/tin-tuc/benh-ly-chung-vung-rang-mieng">Bệnh lý <br/> răng miệng</a> 
			<a class="gray block" href="/tin-tuc/cap-nhat-ve-nha-khoa">Cập nhật<br/> về <br/> nha khoa</a> 
			<a class="dark-blue block" href="/tin-tuc/video">Video </a>
		</div>
	</div>
</div>
...
<div class="region support col-xs-12 text-center">
	...
	<div class="region-content text-center" style="padding:20px;">
		...
		<div class="support-frm">
                ...
                ?>
                <span class="support-frm-title">Răng của tôi đang trong
				tình trạng nào nhỉ?</span>
			<div class="support-frm-content"
				ng-controller="ProfileHomeController">
				<div class="support-content-left">
					<span class="title">Tuổi mọc răng <br/>  của bạn </span> <span
						class="content"> Nơi lưu trữ tuổi mọc răngcủa các thành viên<br /><br />
					</span> <a href="<?php echo $url;?>" class="btn btn-primary">Chi
						tiết &gt;&gt;</a>
				</div>
				<div class="support-content-right">
					<span class="title">Hồ sơ răng miệng  <br/>  cá nhân</span>
					<div class="content">
						Nơi lưu trữ tình trạng răng miệng của các thành viên<br/><br/>
					</div>
					<a ng-click="openProfilePage()" class="btn btn-primary">Tư vấn
						&gt;&gt;</a>
