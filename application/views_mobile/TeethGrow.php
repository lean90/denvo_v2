...
<div class="body-content width-960" ng-controller="TeethGrowController">
    <form id="profile-support-frm" action="/profile/<?php echo $userid?>/tuoi-moc-rang/send_support" novalidate method="post" enctype="multipart/form-data">
        <input name="data" type="hidden" value="{{getPostDataForSupport()}}" />
    </form>
    <form id="profile-support-response-frm" action="/profile/<?php echo $userid?>/tuoi-moc-rang/response_support" novalidate method="post" enctype="multipart/form-data">
    ...
    <form id="profile-frm" novalidate method="post" enctype="multipart/form-data">
        <input name="data" type="hidden" value="{{getPostData()}}" /> <input name="send" type="hidden" value="{{isSendEmail}}" />
