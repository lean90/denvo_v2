        ...
        <aside class="left-side sidebar-offcanvas">
            ...
            <section class="sidebar">
                ...
                <ul class="sidebar-menu">
                    <li class="active"><a href="/__admin"> <i class="fa fa-dashboard"></i> <span>Dashboard</span>
                    </a></li>
                    <li><a href="/__admin/account"> <i class="glyphicon glyphicon-user"></i> <span>Tài khoản</span>
                    </a></li>
                    <li><a href="/__admin/setting_support"> <i class="fa fa-fw fa-users"></i> <span>Cộng tác viên</span>
                    </a></li>
                    <li><a href="/__admin/setting"> <i class="fa fa-th"></i> <span>Setting hệ thống</span>
                    </a></li>
                </ul>
            </section>
            <!-- /.sidebar -->
