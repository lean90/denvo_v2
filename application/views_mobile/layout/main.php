...
<link rel="stylesheet" type="text/css"
	href="/js/plugins/datepicker/css/datepicker.css" media="all">
<script
	src="http://ajax.googleapis.com/ajax/libs/jquery/2.0.2/jquery.min.js"></script>
<script type="text/javascript" src="/js/detect_screen.js"
	charset="utf-8"></script>
<link type="text/css" href="/dento-chat/cometchatcss.php"
	rel="stylesheet">
<script type="text/javascript" src="/dento-chat/cometchatjs.php"
	charset="utf-8"></script>
...
<body class="skin-blue" style="min-width: 640px">
	...
	<div id="header-container" class="header col-xs-12 text-center">
		<a class="mn-btn" href="#"></a> <a class="logo" href="/home"><img
			src="/img/Logo-home.png" /></a> <a class="search-btn" href="/search"></a>
	</div>
		...
		<div class="footer-container width-960">
			<ul class="static-col">
				<li>Thông tin liên hệ
					<div
						style="position: absolute; margin-top: -35px; margin-left: 348px;">
						<a class="btn btn-primary" style="color: white; font-size: 30px"
					...
					<ul>
						<li><a><img src="/img/footer-icon-phone.fw.png" /> Hotline:
								0933.22.8001</a></li>
						<li><a><img src="/img/footer-icon-mail.fw.png"
								style="vertical-align: middle;" /> Email: admin@dento.vn</a></li>
						<li><a><img src="/img/footer-icon-home.fw.png" /> Địa chỉ: Số 6,
								ngõ 6, tổ 6, tập thể Nhà máy In Quân Đội, Cầu Diễn, Bắc Từ Liêm,
								Hà Nội</a></li>
	...
	<div id="overlap"
		style="display: none; background: rgba(0, 0, 0, 0.5) url(); position: fixed; top: 0px; left: 0px; width: 100%; height: 100%; z-index: 9999">
