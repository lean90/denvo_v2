<?php
/*
 * Abraham Williams (abraham@abrah.am) http://abrah.am The first PHP Library to support OAuth for Twitter's REST API.
 */
...
class TwitterOAuth {
	 ...
	 *
	 * @return s a key/value array containing oauth_token and oauth_token_secret
	 */
	 ...
	 *
	 * @return s array("oauth_token" => "the-access-token",
...
// 		curl_setopt($ci, CURLOPT_CAINFO, APPPATH.'certificates/ca-bundle.crt');
