<div class="body-content width-960">
	<div class="scrum-map width-960px">
		<div class="current-page">Thông tin cá nhân - <?php echo $me->full_name;?></div>
	</div>
	<div class="detail-view post-view width-960">
		<div class="left">
			...
			<div class="form-group col-md-8">
				<label for="thumbnail">Ngày sinh : </label> <label
					style="color: #0F75BC"> <?php echo DateTime::createFromFormat(DatabaseFixedValue::DEFAULT_FORMAT_DATE, $me->dob)->format('d/m/Y');?></label>
			</div>
			<div class="form-group col-md-8">
				<label for="thumbnail">Giới tính : </label> <label
					style="color: #0F75BC"> 
                        <?php
																								switch ($me->gender) {
																									case 'MALE' :
