<div class="overlay-menu">
    <ul class="mobile-main-menu">
        ...
        ?>
             <li class="big-item"><a href="/login?cp=<?php echo urlencode(Common::curPageURL());?>"> <img src="/img/mn-icon-login.png" /><span> Đăng nhập </span></a>  </li>
        <?php }else{ ?>
        ...
        <?php } ?>
            <li class="big-item"><a href="/home"> TRANG CHỦ</a></li>
            ...
            <li class="big-item"><a href="/dento-chat"> CHAT CÙNG BẠN BÈ</a></li>
            <li class="big-item"><a href="/danh-sach-cau-hoi"> HỎI ĐÁP</a></li>
            ...
            <li><a href="/tin-tuc/benh-ly-chung-vung-rang-mieng"><img src="/img/mn-icon-benh-ly-vung-rang-mieng.fw.png" /><span>Bệnh lý răng miệng</span></a></li>
            <li><a href="/tin-tuc/theo-doi-cham-soc-rang-mieng-theo-lua-tuoi"><img src="/img/mn-icon-cham-soc-theo-lua-tuoi.fw.png" /><span>Theo dõi chăm sóc răng miệng ...</span></a></li>
            ...
            <li><a href="/home#support"> <img src="/img/mn-icon-support.png" /> <span>Trợ giúp </span></a>  </li>
            ...
            <li><a href="/san-pham/khac"><img src="/img/mn-icon-khac.fw.png" /><span>Khác</span></a></li>
            ...
            <li><a href="/ky-thuat/nan-chinh"><img src="/img/mn-icon-nan-chinh.fw.png" /><span>Nắm chỉnh</span></a></li>
            ...
            <li><a href="/tuyen-dung/cong-tac-vien"><img src="/img/mn-icon-support.png" /><span>Cộng tác viên</span></a></li>
            <li><a href="/tuyen-dung/quan-tri-vien"><img src="/img/mn-icon-support.png" /><span>Quản trị viên</span></a></li>
            
            <?php if(!empty($current_user->id)){?>
                <li class="big-item"><a href="/logout"> ĐĂNG XUẤT</a></li>
            <?php }?>
