...
<div class="region support col-xs-12 text-center">
	...
	<div class="region-content  width-840 height-640 text-center">
		...
		<div class="support-frm">
			...
			<div class="support-frm-content"
				...
				<div class="support-content-left">
					<span class="title">Tuổi mọc răng của tôi và gia đình</span> <span
						class="content"> Nơi lưu trữ tuổi mọc răng<br /> của tôi cũng như
						các thành viên<br /> trong gia đình tôi<br />
					</span> <a href="<?php echo $url;?>" class="btn btn-primary">Chi
						tiết &gt;&gt;</a>
				</div>
				<div class="support-content-right">
					<span class="title">Tình trạng răng miệng của tôi</span>
					<div class="content">
						<table>
							<tr>
								<td style="text-align: left; width: 50px">Họ tên</td>
								<td class="text-left"><input ng-model="selectedHistory"
									typeahead="history as history.full_name for history in histories | filter:{full_name:$viewValue}"
									type="text" placeholder="Nhập tên" /></td>
							</tr>
							<tr>
								<td style="text-align: left">Ngày sinh</td>
								<td class="text-left"><input ng-model="selectedHistory.dob"
									style="margin-top: 5px" type="text" placeholder="Ngày sinh" /></td>
							</tr>
						</table>
					</div>
		...
		<div class="chat-frm">
			...
			<div class="chat-frm-content" onclick="openChatDialog()"></div>
		</div>
	</div>
</div>
