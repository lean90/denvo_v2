<div class="body-content width-960 position-detail" ng-controller="DetailPositionController">
    <div class="scrum-map width-960px">
        <div class="current-page" ng-show="info.position_type == 'PHONG-KHAM'">Kết quả tìm phòng khám</div>
        <div class="current-page" ng-show="info.position_type == 'LABO'">Kết quả tìm labo</div>
        <div class="current-page" ng-show="info.position_type == 'CO-SO-VLNK'">Kết quả tìm cơ sở vật liệu nha khoa</div>
        <ul class="map">
            <li><a href="/">Trang chủ</a><span>&gt;</span></li>
            <li><a href="/ban-do">Bản đồ</a><span>&gt;</span></li>
            <li><a href="#">Chi tiết thông tin</a><span>&gt;</span></li>
        </ul>
    </div>
