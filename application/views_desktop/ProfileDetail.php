<div class="profile-box profile-box-add form-horizontal" style="border: none; padding: 0px; margin: 0px;">
    ...
    <div class="col-md-12 " style="margin-top: 15px; position: inherit;">
        <div class="profile-title-higlight" style="float: left; margin-top: -40px;">Sơ đồ răng sữa</div>
        <div class="profile-title-higlight" style="float: right; margin-top: -40px;">Sơ đồ răng vĩnh viễn</div>
        <div class="schema-conatiner">
            ...
            <ul ng-click="selectedDetailTeeth($event, teethMenPosition)" ng-mousemove="setTootipOnMouseMove($event,teethMenPosition)" class="schema men" style="margin-top: -51px;">
    ...
    <div class="col-md-12 text-center" style="margin: 15px 0px;" ng-show='me.id == selectedHistory.user_id'>
        <a href="javascript:void(0);" ng-click="enableEditProfile()" class="btn btn-primary"> <i class="glyphicon glyphicon-edit" style="color: white"></i> &nbsp; Chỉnh sửa</a> 
        <a href="javascript:void(0);" ng-click='sendSupport()' class="btn btn-default"> <i class="glyphicon glyphicon-send" style="color: black"></i> &nbsp; Yêu cầu tư vấn</a>
        <a ng-href="/profile/{{me.id}}/ho-so-rang-mieng/{{selectedHistory.id}}/del" class="btn btn-danger"> <i class="glyphicon glyphicon-floppy-remove" style="color: white"></i> &nbsp; Xóa</a>
    </div>
    <div class="text-right absolute-profile-button" ng-show='me.id == selectedHistory.user_id'>
        <a href="javascript:void(0);" ng-click="enableEditProfile()" class="btn btn-primary"> <i class="glyphicon glyphicon-edit"></i> &nbsp; Chỉnh sửa</a><br /> <br /> 
        <a href="javascript:void(0);" ng-click='sendSupport()' style="width: 113px;" class="btn btn-default"> <i class="glyphicon glyphicon-send" style="color: black"></i> &nbsp; Tư vấn</a><br/><br/>
        <a ng-href="/profile/{{me.id}}/ho-so-rang-mieng/{{selectedHistory.id}}/del"  style="width: 113px;" class="btn btn-danger"> <i class="glyphicon glyphicon-floppy-remove" style="color: white"></i> &nbsp; Xóa</a>
    </div>
</div>