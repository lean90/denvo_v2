...
<div id="login-Pop" class="login-pop dento-pop"
	...
	<form id="login-frm">
		<div class="form-group login-frm col-xs-12 text-left">
			<div class="login-invalid" ng-show="loginedResult">Tên đăng nhập hoặc
				mật khẩu không đúng.</div>
			<input name="us" ng-model="us" type="text" class="form-control"
				placeholder="Email" /> <input name="ps" ng-model="ps"
				type="password" class="form-control" placeholder="Password" />
			<div class="checkbox text-left">
				<label class="">
					<div class="icheckbox_minimal" aria-checked="false"
						aria-disabled="false"
						style="position: relative; margin-top: -3px;">
						<input ng-model="re" name="cbkRemember" type="checkbox"
			...
			<button type="button" ng-click="Login()" class="btn btn-primary">Đăng
				nhập</button>
			<a class="resg-link" href="#">Đăng ký</a> <a
				class="pass-link col-xs-12" href="/lost_password">Quên mật khẩu</a>
		</div>
	</form>
</div>
...
<div id="resgitor-window" class="page-mark text-left"
	style="display: none">
			...
			<div class="box box-primary" style="display: inline-block;">
				<div class="box-header" title="">
					...
					<div class="box-tools pull-right">
						<button id="close-btn" class="btn btn-primary btn-xs"
							data-widget="remove">
				...
				<div class="box-body col-xs-12" style="display: inline-block;">
					...
					<div class="form-group col-xs-6">
						<label for="dob">Giới tính</label> <select name="gender"
							class="form-control">
					...
					<div class="form-group col-xs-6">
						<label for="avatar">Ảnh đại diện</label> <input
							name="client-avatar" accept="image/x-png, image/gif, image/jpeg"
							type="file" id="avatar" />
					</div>
						...
						<div class="checkbox">
							<label class="">
								<div class="icheckbox_minimal" aria-checked="false"
									...
									<input id="chkagree" name="chkagree" type="checkbox"
										style="position: absolute; opacity: 0;" required />
									<ins class="iCheck-helper"
										style="position: absolute; top: 0%; left: 0%; display: block; width: 100%; height: 100%; margin: 0px; padding: 0px; border: 0px; opacity: 0; background: rgb(255, 255, 255);"></ins>
								</div> Tôi đồng ý với <a href="/gioi-thieu/dieu-khoan-su-dung-200.html">điều
