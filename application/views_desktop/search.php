...
foreach ( $posts as $post ) {
                ...
                <div class='item-in-list'>
                    ...
                    <div class='post-view'>{$post->created_at} <span> | </span> Số lần xem : {$post->view_count} lượt
                    <a class='list-admin-tool' style='display:{$showAdminLink}' href='{$editUrl}'><i class='glyphicon glyphicon-edit'></i> Chỉnh sửa</a>
                    <a class='list-admin-tool' style='display:{$showAdminLink}' href='{$deleteUrl}'><i class='glyphicon glyphicon-floppy-remove'></i> Xóa </a>    
                    </div>
                    <div class='post-desc'>
                        {$post->description}
                        <a href='{$url}'>Xem tiếp</a>
                    </div>
