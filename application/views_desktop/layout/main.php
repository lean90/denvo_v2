...
<script type="text/javascript">
    ...
    <div class="header col-xs-12 text-center">
        <div class="header-container width-960">
            <a href="/" class="logo"><img src="/img/Logo.fw.png" /></a>
            <div class="head-tool text-right">
                ...
                <div class="header-search">
                    <?php
																				...
																				?>
                    <span id="search-pop-btn" class="btn"> <img src="/img/btn-search.fw.png" />
                    </span>
                </div>
            </div>
        </div>
		...
		<div class="menu-conatiner width-960">
            <ul class="cursor-pointer">
                <li class="child-home text-left" style=""><a href="/home"><img src="/img/home.fw.png" /></a></li>
                <li>
                    ...
                    </ul> <a href="/gioi-thieu/ve-chung-toi-43.html">Giới thiệu</a>
                </li>
                <li>
                    <ul class="child text-left">
                        <li class="topMenu-newItem" style="display:<?php echo $__newStatus__->tintuc == false ? "none" : "block;"?>">
                            <div>
                                <p class="newItem-head">
                                    <img src="/img/menu-icon-new-top.png" /> Tin Mới
                                </p>
                                <ul class="menu-newlist">
                                    <?php
																																				
foreach ( $__newStatus__->datasource as $item ) {
																																					if ($item->item_type != 'tintuc') {
																																						continue;
																																					}
																																					?>
                                        <li><a href="<?php echo $item->part_url.'-'.$item->id.'.html';?>">
            ...
            <ul class="dynamic-col">
                ...
                <li>Tin tức
                    <ul>
                        ...
                        <li><a href="/tin-tuc/theo-doi-cham-soc-rang-mieng-theo-lua-tuoi">Theo dõi chăm sóc răng miệng theo <br /> lứa tuổi
                        </a></li>
            ...
            <ul class="static-col">
                <li>THÔNG TIN LIÊN HỆ
                    <ul>
                        ...
                        <li><a>Địa chỉ: Số 6, ngõ 6, tổ 6, <br />tập thể Nhà máy In Quân Đội, Cầu Diễn,<br /> Bắc Từ Liêm, Hà Nội
                        </a></li>
                        <li><br /></li>
