...
<body class="skin-blue">
    ...
    <header class="header">
        <a href="/__admin" class="logo"> <!-- Add the class icon to your logo image or logo icon to add the margining --> DENTO
        </a>
        <!-- Header Navbar: style can be found in header.less -->
        <nav class="navbar navbar-static-top" role="navigation">
            <!-- Sidebar toggle button-->
            <a href="#" class="navbar-btn sidebar-toggle" data-toggle="offcanvas" role="button"> <span class="sr-only">Toggle navigation</span> <span class="icon-bar"></span> <span class="icon-bar"></span> <span class="icon-bar"></span>
            </a>
            <div class="navbar-right">
                <ul class="nav navbar-nav">
                    <li class="dropdown user user-menu"><a href="#" class="dropdown-toggle" data-toggle="dropdown"> <i class="glyphicon glyphicon-user"></i> <span><?php echo Common::getCurrentUser()->full_name?><i class="caret"></i></span>
                    </a>
                        <ul class="dropdown-menu">
                            <!-- User image -->
                            <li class="user-header bg-light-blue"><img src="<?php echo Common::getCurrentUser()->avartar; ?>" class="img-circle" alt="User Image" />
                                <p>
                            ...
                            <li class="user-footer">
                                <div class="pull-left">
                                    <a href="/profile/<?php Common::getCurrentUser()->id?>" class="btn btn-default btn-flat">Profile</a>
                                </div>
            ...
            <section class="sidebar">
                ...
                <div class="user-panel">
                    <div class="pull-left image">
                        <img src="<?php echo Common::getCurrentUser()->avartar ?>" class="img-circle" alt="User Image" />
                    </div>
                ...
                <ul class="sidebar-menu">
                    <li class="active"><a href="/__admin"> <i class="fa fa-dashboard"></i> <span>Dashboard</span></a></li>
                    <li><a href="/__admin/account"> <i class="glyphicon glyphicon-user"></i> <span>Tài khoản</span></a></li>
                    <li><a href="/__admin/setting_support"> <i class="fa fa-fw fa-users"></i> <span>Cộng tác viên</span></a></li>
                    <li><a href="/__admin/setting"> <i class="fa fa-th"></i> <span>Setting hệ thống</span></a></li>
                    <li><a href="/__admin/maps"> <i class="fa fa-th"></i> <span>Setting bản đồ</span></a></li>
                </ul>
            </section>
            <!-- /.sidebar -->
        </aside>
