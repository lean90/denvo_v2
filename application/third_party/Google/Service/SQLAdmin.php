...
class Google_Service_SQLAdmin extends Google_Service {
	...
	public function __construct(Google_Client $client) {
		...
		$this->backupRuns = new Google_Service_SQLAdmin_BackupRuns_Resource ( $this, $this->serviceName, 'backupRuns', array (
				'methods' => array (
						'get' => array (
		...
		$this->flags = new Google_Service_SQLAdmin_Flags_Resource ( $this, $this->serviceName, 'flags', array (
				'methods' => array (
						'list' => array (
								'path' => 'flags',
								'httpMethod' => 'GET',
		...
		$this->instances = new Google_Service_SQLAdmin_Instances_Resource ( $this, $this->serviceName, 'instances', array (
				'methods' => array (
						'clone' => array (
		...
		$this->operations = new Google_Service_SQLAdmin_Operations_Resource ( $this, $this->serviceName, 'operations', array (
				'methods' => array (
						'get' => array (
		...
		$this->sslCerts = new Google_Service_SQLAdmin_SslCerts_Resource ( $this, $this->serviceName, 'sslCerts', array (
				'methods' => array (
						'delete' => array (
		...
		$this->tiers = new Google_Service_SQLAdmin_Tiers_Resource ( $this, $this->serviceName, 'tiers', array (
				'methods' => array (
						'list' => array (
...
class Google_Service_SQLAdmin_Instances_Resource extends Google_Service_Resource {
	...
	public function cloneInstances($project, Google_Service_SQLAdmin_InstancesCloneRequest $postBody, $optParams = array()) {
		...
		$params = array_merge ( $params, $optParams );
		return $this->call ( 'clone', array (
				$params 
		), "Google_Service_SQLAdmin_InstancesCloneResponse" );
	}
	/**
	...
	public function patch($project, $instance, Google_Service_SQLAdmin_DatabaseInstance $postBody, $optParams = array()) {
		...
		return $this->call ( 'patch', array (
				$params 
		), "Google_Service_SQLAdmin_InstancesUpdateResponse" );
	}
	/**
	...
	public function promoteReplica($project, $instance, $optParams = array()) {
		...
		$params = array_merge ( $params, $optParams );
		return $this->call ( 'promoteReplica', array (
				$params 
	...
	public function resetSslConfig($project, $instance, $optParams = array()) {
		...
		$params = array_merge ( $params, $optParams );
		return $this->call ( 'resetSslConfig', array (
				$params 
		), "Google_Service_SQLAdmin_InstancesResetSslConfigResponse" );
	}
	/**
	...
	public function restoreBackup($project, $instance, $backupConfiguration, $dueTime, $optParams = array()) {
		...
		$params = array_merge ( $params, $optParams );
		return $this->call ( 'restoreBackup', array (
				$params 
	...
	public function setRootPassword($project, $instance, Google_Service_SQLAdmin_InstanceSetRootPasswordRequest $postBody, $optParams = array()) {
		...
		$params = array_merge ( $params, $optParams );
		return $this->call ( 'setRootPassword', array (
				$params 
...
class Google_Service_SQLAdmin_SslCerts_Resource extends Google_Service_Resource {
	...
	public function delete($project, $instance, $sha1Fingerprint, $optParams = array()) {
		...
		return $this->call ( 'delete', array (
				$params 
		), "Google_Service_SQLAdmin_SslCertsDeleteResponse" );
	}
	/**
