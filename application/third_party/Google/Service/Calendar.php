...
class Google_Service_Calendar extends Google_Service {
	...
	public function __construct(Google_Client $client) {
		...
		$this->acl = new Google_Service_Calendar_Acl_Resource ( $this, $this->serviceName, 'acl', array (
				'methods' => array (
						'delete' => array (
		...
		$this->calendarList = new Google_Service_Calendar_CalendarList_Resource ( $this, $this->serviceName, 'calendarList', array (
				'methods' => array (
						'delete' => array (
		...
		$this->calendars = new Google_Service_Calendar_Calendars_Resource ( $this, $this->serviceName, 'calendars', array (
				'methods' => array (
						'clear' => array (
		...
		$this->channels = new Google_Service_Calendar_Channels_Resource ( $this, $this->serviceName, 'channels', array (
				'methods' => array (
						'stop' => array (
								'path' => 'channels/stop',
								'httpMethod' => 'POST',
		...
		$this->colors = new Google_Service_Calendar_Colors_Resource ( $this, $this->serviceName, 'colors', array (
				'methods' => array (
						'get' => array (
								'path' => 'colors',
								'httpMethod' => 'GET',
		...
		$this->events = new Google_Service_Calendar_Events_Resource ( $this, $this->serviceName, 'events', array (
				'methods' => array (
						'delete' => array (
		...
		$this->freebusy = new Google_Service_Calendar_Freebusy_Resource ( $this, $this->serviceName, 'freebusy', array (
				'methods' => array (
						'query' => array (
								'path' => 'freeBusy',
								'httpMethod' => 'POST',
		...
		$this->settings = new Google_Service_Calendar_Settings_Resource ( $this, $this->serviceName, 'settings', array (
				'methods' => array (
						'get' => array (
...
class Google_Service_Calendar_Calendars_Resource extends Google_Service_Resource {
	 ...
	 * This operation deletes all data associated with
...
class Google_Service_Calendar_Events_Resource extends Google_Service_Resource {
	...
	/**
	 * Imports an event.
	 * This operation is used to add a private copy of an existing
	...
	public function instances($calendarId, $eventId, $optParams = array()) {
		...
		$params = array_merge ( $params, $optParams );
		return $this->call ( 'instances', array (
				$params 
	...
	public function quickAdd($calendarId, $text, $optParams = array()) {
		...
		$params = array_merge ( $params, $optParams );
		return $this->call ( 'quickAdd', array (
				$params 
		), "Google_Service_Calendar_Event" );
	}
	/**
