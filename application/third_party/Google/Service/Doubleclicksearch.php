...
class Google_Service_Doubleclicksearch extends Google_Service {
	...
	public function __construct(Google_Client $client) {
		...
		$this->conversion = new Google_Service_Doubleclicksearch_Conversion_Resource ( $this, $this->serviceName, 'conversion', array (
				'methods' => array (
						'get' => array (
		...
		$this->reports = new Google_Service_Doubleclicksearch_Reports_Resource ( $this, $this->serviceName, 'reports', array (
				'methods' => array (
						'generate' => array (
		...
		$this->savedColumns = new Google_Service_Doubleclicksearch_SavedColumns_Resource ( $this, $this->serviceName, 'savedColumns', array (
				'methods' => array (
						'list' => array (
...
class Google_Service_Doubleclicksearch_Conversion_Resource extends Google_Service_Resource {
	...
	public function updateAvailability(Google_Service_Doubleclicksearch_UpdateAvailabilityRequest $postBody, $optParams = array()) {
		...
		$params = array_merge ( $params, $optParams );
		return $this->call ( 'updateAvailability', array (
				$params 
...
class Google_Service_Doubleclicksearch_Reports_Resource extends Google_Service_Resource {
	...
	public function getFile($reportId, $reportFragment, $optParams = array()) {
		...
		$params = array_merge ( $params, $optParams );
		return $this->call ( 'getFile', array (
				$params 
		) );
	}
	/**
