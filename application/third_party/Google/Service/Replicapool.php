...
class Google_Service_Replicapool extends Google_Service {
	...
	public function __construct(Google_Client $client) {
		...
		$this->pools = new Google_Service_Replicapool_Pools_Resource ( $this, $this->serviceName, 'pools', array (
				'methods' => array (
						'delete' => array (
		...
		$this->replicas = new Google_Service_Replicapool_Replicas_Resource ( $this, $this->serviceName, 'replicas', array (
				'methods' => array (
						'delete' => array (
...
class Google_Service_Replicapool_Pools_Resource extends Google_Service_Resource {
	...
	/**
	 * Resize a pool.
	 * This is an asynchronous operation, and multiple overlapping
	...
	public function updatetemplate($projectName, $zone, $poolName, Google_Service_Replicapool_Template $postBody, $optParams = array()) {
		...
		$params = array_merge ( $params, $optParams );
		return $this->call ( 'updatetemplate', array (
				$params 
		) );
	}
}
