...
class Google_Service_Storage extends Google_Service {
	...
	public function __construct(Google_Client $client) {
		...
		$this->bucketAccessControls = new Google_Service_Storage_BucketAccessControls_Resource ( $this, $this->serviceName, 'bucketAccessControls', array (
				'methods' => array (
						'delete' => array (
		...
		$this->buckets = new Google_Service_Storage_Buckets_Resource ( $this, $this->serviceName, 'buckets', array (
				'methods' => array (
						'delete' => array (
								'path' => 'b/{bucket}',
								'httpMethod' => 'DELETE',
		...
		$this->channels = new Google_Service_Storage_Channels_Resource ( $this, $this->serviceName, 'channels', array (
				'methods' => array (
						'stop' => array (
								'path' => 'channels/stop',
								'httpMethod' => 'POST',
		...
		$this->defaultObjectAccessControls = new Google_Service_Storage_DefaultObjectAccessControls_Resource ( $this, $this->serviceName, 'defaultObjectAccessControls', array (
				'methods' => array (
						'delete' => array (
		...
		$this->objectAccessControls = new Google_Service_Storage_ObjectAccessControls_Resource ( $this, $this->serviceName, 'objectAccessControls', array (
				'methods' => array (
						'delete' => array (
		...
		$this->objects = new Google_Service_Storage_Objects_Resource ( $this, $this->serviceName, 'objects', array (
				'methods' => array (
						'compose' => array (
...
class Google_Service_Storage_Objects_Resource extends Google_Service_Resource {
	...
	public function compose($destinationBucket, $destinationObject, Google_Service_Storage_ComposeRequest $postBody, $optParams = array()) {
		...
		$params = array_merge ( $params, $optParams );
		return $this->call ( 'compose', array (
				$params 
	 ...
	 * Deletions are permanent if versioning is
	...
	public function watchAll($bucket, Google_Service_Storage_Channel $postBody, $optParams = array()) {
		...
		$params = array_merge ( $params, $optParams );
		return $this->call ( 'watchAll', array (
				$params 
