...
class Google_Service_Dns extends Google_Service {
	...
	public function __construct(Google_Client $client) {
		...
		$this->changes = new Google_Service_Dns_Changes_Resource ( $this, $this->serviceName, 'changes', array (
				'methods' => array (
						'create' => array (
		...
		$this->managedZones = new Google_Service_Dns_ManagedZones_Resource ( $this, $this->serviceName, 'managedZones', array (
				'methods' => array (
						'create' => array (
		...
		$this->projects = new Google_Service_Dns_Projects_Resource ( $this, $this->serviceName, 'projects', array (
				'methods' => array (
						'get' => array (
								'path' => '{project}',
								'httpMethod' => 'GET',
		...
		$this->resourceRecordSets = new Google_Service_Dns_ResourceRecordSets_Resource ( $this, $this->serviceName, 'resourceRecordSets', array (
				'methods' => array (
						'list' => array (
