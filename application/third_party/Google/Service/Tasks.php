...
class Google_Service_Tasks extends Google_Service {
	...
	public function __construct(Google_Client $client) {
		...
		$this->tasklists = new Google_Service_Tasks_Tasklists_Resource ( $this, $this->serviceName, 'tasklists', array (
				'methods' => array (
						'delete' => array (
		...
		$this->tasks = new Google_Service_Tasks_Tasks_Resource ( $this, $this->serviceName, 'tasks', array (
				'methods' => array (
						'clear' => array (
