...
class Google_Service_Genomics extends Google_Service {
	...
	public function __construct(Google_Client $client) {
		...
		$this->beacons = new Google_Service_Genomics_Beacons_Resource ( $this, $this->serviceName, 'beacons', array (
				'methods' => array (
						'get' => array (
		...
		$this->callsets = new Google_Service_Genomics_Callsets_Resource ( $this, $this->serviceName, 'callsets', array (
				'methods' => array (
						'create' => array (
								'path' => 'callsets',
								'httpMethod' => 'POST',
		...
		$this->experimental_jobs = new Google_Service_Genomics_ExperimentalJobs_Resource ( $this, $this->serviceName, 'jobs', array (
				'methods' => array (
						'create' => array (
		...
		$this->jobs = new Google_Service_Genomics_Jobs_Resource ( $this, $this->serviceName, 'jobs', array (
				'methods' => array (
						'cancel' => array (
		...
		$this->reads = new Google_Service_Genomics_Reads_Resource ( $this, $this->serviceName, 'reads', array (
				'methods' => array (
						'search' => array (
								'path' => 'reads/search',
								'httpMethod' => 'POST',
		...
		$this->readsets = new Google_Service_Genomics_Readsets_Resource ( $this, $this->serviceName, 'readsets', array (
				'methods' => array (
						'delete' => array (
		...
		$this->readsets_coveragebuckets = new Google_Service_Genomics_ReadsetsCoveragebuckets_Resource ( $this, $this->serviceName, 'coveragebuckets', array (
				'methods' => array (
						'list' => array (
		...
		$this->variants = new Google_Service_Genomics_Variants_Resource ( $this, $this->serviceName, 'variants', array (
				'methods' => array (
						'create' => array (
								'path' => 'variants',
								'httpMethod' => 'POST',
...
class Google_Service_Genomics_Beacons_Resource extends Google_Service_Resource {
	 ...
	 * Health Beacon.
	 * It may change at any time. (beacons.get)
	 *
	...
	public function get($datasetId, $optParams = array()) {
		...
		return $this->call ( 'get', array (
				$params 
		), "Google_Service_Genomics_Beacon" );
	}
}
...
class Google_Service_Genomics_Jobs_Resource extends Google_Service_Resource {
	...
	/**
	 * Cancels a job by ID.
	 * Note that it is possible for partial results to be
...
class Google_Service_Genomics_Reads_Resource extends Google_Service_Resource {
	...
	/**
	 * Gets a list of reads for one or more readsets.
	 * Reads search operates over a
...
class Google_Service_Genomics_Readsets_Resource extends Google_Service_Resource {
	...
	/**
	 * Exports readsets to a BAM file in Google Cloud Storage.
	 * Note that currently
	...
	public function export(Google_Service_Genomics_ExportReadsetsRequest $postBody, $optParams = array()) {
		...
		$params = array_merge ( $params, $optParams );
		return $this->call ( 'export', array (
				$params 
		), "Google_Service_Genomics_ExportReadsetsResponse" );
	}
	/**
	...
	public function get($readsetId, $optParams = array()) {
		...
		return $this->call ( 'get', array (
				$params 
		), "Google_Service_Genomics_Readset" );
	}
	/**
	...
	public function import(Google_Service_Genomics_ImportReadsetsRequest $postBody, $optParams = array()) {
		...
		$params = array_merge ( $params, $optParams );
		return $this->call ( 'import', array (
				$params 
		), "Google_Service_Genomics_ImportReadsetsResponse" );
	}
	/**
	 * Updates a readset.
	 * This method supports patch semantics. (readsets.patch)
	 *
	 * @param string $readsetId
...
class Google_Service_Genomics_ReadsetsCoveragebuckets_Resource extends Google_Service_Resource {
	 ...
	 * a range of a reference sequence.
	 * Each bucket summarizes coverage information
...
class Google_Service_Genomics_Variants_Resource extends Google_Service_Resource {
	...
	public function getSummary($optParams = array()) {
		$params = array ();
		$params = array_merge ( $params, $optParams );
		return $this->call ( 'getSummary', array (
				$params 
		), "Google_Service_Genomics_GetVariantsSummaryResponse" );
	}
	/**
	...
	/**
	 * Updates a variant.
	 * This method supports patch semantics. (variants.patch)
	 *
	 * @param string $variantId
