...
class Google_Service_Coordinate extends Google_Service {
	...
	public function __construct(Google_Client $client) {
		...
		$this->customFieldDef = new Google_Service_Coordinate_CustomFieldDef_Resource ( $this, $this->serviceName, 'customFieldDef', array (
				'methods' => array (
						'list' => array (
		...
		$this->jobs = new Google_Service_Coordinate_Jobs_Resource ( $this, $this->serviceName, 'jobs', array (
				'methods' => array (
						'get' => array (
		...
		$this->location = new Google_Service_Coordinate_Location_Resource ( $this, $this->serviceName, 'location', array (
				'methods' => array (
						'list' => array (
		...
		$this->schedule = new Google_Service_Coordinate_Schedule_Resource ( $this, $this->serviceName, 'schedule', array (
				'methods' => array (
						'get' => array (
		...
		$this->worker = new Google_Service_Coordinate_Worker_Resource ( $this, $this->serviceName, 'worker', array (
				'methods' => array (
						'list' => array (
								'path' => '{teamId}/workers',
								'httpMethod' => 'GET',
...
class Google_Service_Coordinate_Jobs_Resource extends Google_Service_Resource {
	...
	/**
	 * Inserts a new job.
	 * Only the state field of the job should be set.
	 * (jobs.insert)
	 *
	 * @param string $teamId
	 *        	Team ID
	...
	/**
	 * Updates a job.
	 * Fields that are set in the job state will be updated. This
	...
	/**
	 * Updates a job.
	 * Fields that are set in the job state will be updated.
	 * (jobs.update)
	 *
	 * @param string $teamId
	 *        	Team ID
