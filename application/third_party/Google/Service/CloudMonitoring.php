...
class Google_Service_CloudMonitoring extends Google_Service {
	...
	public function __construct(Google_Client $client) {
		...
		$this->metricDescriptors = new Google_Service_CloudMonitoring_MetricDescriptors_Resource ( $this, $this->serviceName, 'metricDescriptors', array (
				'methods' => array (
						'list' => array (
		...
		$this->timeseries = new Google_Service_CloudMonitoring_Timeseries_Resource ( $this, $this->serviceName, 'timeseries', array (
				'methods' => array (
						'list' => array (
		...
		$this->timeseriesDescriptors = new Google_Service_CloudMonitoring_TimeseriesDescriptors_Resource ( $this, $this->serviceName, 'timeseriesDescriptors', array (
				'methods' => array (
						'list' => array (
...
class Google_Service_CloudMonitoring_Timeseries_Resource extends Google_Service_Resource {
	 ...
	 * values and that have data points in the interval.
	 * Large responses are
	 * paginated; use the nextPageToken returned in the response to request
	 * subsequent pages of results by setting the pageToken query parameter to the
