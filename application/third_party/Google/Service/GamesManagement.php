...
class Google_Service_GamesManagement extends Google_Service {
	...
	public function __construct(Google_Client $client) {
		...
		$this->achievements = new Google_Service_GamesManagement_Achievements_Resource ( $this, $this->serviceName, 'achievements', array (
				'methods' => array (
						'reset' => array (
		...
		$this->applications = new Google_Service_GamesManagement_Applications_Resource ( $this, $this->serviceName, 'applications', array (
				'methods' => array (
						'listHidden' => array (
		...
		$this->events = new Google_Service_GamesManagement_Events_Resource ( $this, $this->serviceName, 'events', array (
				'methods' => array (
						'reset' => array (
		...
		$this->players = new Google_Service_GamesManagement_Players_Resource ( $this, $this->serviceName, 'players', array (
				'methods' => array (
						'hide' => array (
		...
		$this->quests = new Google_Service_GamesManagement_Quests_Resource ( $this, $this->serviceName, 'quests', array (
				'methods' => array (
						'reset' => array (
		...
		$this->rooms = new Google_Service_GamesManagement_Rooms_Resource ( $this, $this->serviceName, 'rooms', array (
				'methods' => array (
						'reset' => array (
								'path' => 'rooms/reset',
								'httpMethod' => 'POST',
		...
		$this->scores = new Google_Service_GamesManagement_Scores_Resource ( $this, $this->serviceName, 'scores', array (
				'methods' => array (
						'reset' => array (
		...
		$this->turnBasedMatches = new Google_Service_GamesManagement_TurnBasedMatches_Resource ( $this, $this->serviceName, 'turnBasedMatches', array (
				'methods' => array (
						'reset' => array (
...
class Google_Service_GamesManagement_Achievements_Resource extends Google_Service_Resource {
	 ...
	 * application.
	 * This method is only accessible to whitelisted tester accounts
	...
	public function resetAll($optParams = array()) {
		$params = array ();
		$params = array_merge ( $params, $optParams );
		return $this->call ( 'resetAll', array (
				$params 
		), "Google_Service_GamesManagement_AchievementResetAllResponse" );
	}
	/**
	 * Resets the achievement with the given ID for the all players.
	 * This method is
	...
	public function resetForAllPlayers($achievementId, $optParams = array()) {
		...
		$params = array_merge ( $params, $optParams );
		return $this->call ( 'resetForAllPlayers', array (
				$params 
		) );
	}
}
...
class Google_Service_GamesManagement_Applications_Resource extends Google_Service_Resource {
	...
	public function listHidden($applicationId, $optParams = array()) {
		...
		$params = array_merge ( $params, $optParams );
		return $this->call ( 'listHidden', array (
				$params 
...
class Google_Service_GamesManagement_Events_Resource extends Google_Service_Resource {
	 ...
	 * This method is only accessible to whitelisted tester
	...
	/**
	 * Reset all player progress on the event for all players.
	 * This method is only
...
class Google_Service_GamesManagement_Scores_Resource extends Google_Service_Resource {
	...
	/**
	 * Reset scores for the specified leaderboard for all players.
	 * This method is
	 * only available to user accounts for your developer console. Only draft
...
class Google_Service_GamesManagement_TurnBasedMatches_Resource extends Google_Service_Resource {
	 ...
	 * This method is only accessible to
