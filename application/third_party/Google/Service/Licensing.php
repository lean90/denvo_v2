...
class Google_Service_Licensing extends Google_Service {
	...
	public function __construct(Google_Client $client) {
		...
		$this->licenseAssignments = new Google_Service_Licensing_LicenseAssignments_Resource ( $this, $this->serviceName, 'licenseAssignments', array (
				'methods' => array (
						'delete' => array (
...
class Google_Service_Licensing_LicenseAssignments_Resource extends Google_Service_Resource {
	...
	public function listForProduct($productId, $customerId, $optParams = array()) {
		...
		$params = array_merge ( $params, $optParams );
		return $this->call ( 'listForProduct', array (
				$params 
	...
	public function listForProductAndSku($productId, $skuId, $customerId, $optParams = array()) {
		...
		$params = array_merge ( $params, $optParams );
		return $this->call ( 'listForProductAndSku', array (
				$params 
		), "Google_Service_Licensing_LicenseAssignmentList" );
	}
	/**
