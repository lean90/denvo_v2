...
class Google_Service_Taskqueue extends Google_Service {
	...
	public function __construct(Google_Client $client) {
		...
		$this->taskqueues = new Google_Service_Taskqueue_Taskqueues_Resource ( $this, $this->serviceName, 'taskqueues', array (
				'methods' => array (
						'get' => array (
		...
		$this->tasks = new Google_Service_Taskqueue_Tasks_Resource ( $this, $this->serviceName, 'tasks', array (
				'methods' => array (
						'delete' => array (
