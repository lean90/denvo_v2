...
class Google_Service_Fusiontables extends Google_Service {
	...
	public function __construct(Google_Client $client) {
		...
		$this->column = new Google_Service_Fusiontables_Column_Resource ( $this, $this->serviceName, 'column', array (
				'methods' => array (
						'delete' => array (
		...
		$this->query = new Google_Service_Fusiontables_Query_Resource ( $this, $this->serviceName, 'query', array (
				'methods' => array (
						'sql' => array (
								'path' => 'query',
								'httpMethod' => 'POST',
		...
		$this->style = new Google_Service_Fusiontables_Style_Resource ( $this, $this->serviceName, 'style', array (
				'methods' => array (
						'delete' => array (
		...
		$this->table = new Google_Service_Fusiontables_Table_Resource ( $this, $this->serviceName, 'table', array (
				'methods' => array (
						'copy' => array (
		...
		$this->task = new Google_Service_Fusiontables_Task_Resource ( $this, $this->serviceName, 'task', array (
				'methods' => array (
						'delete' => array (
		...
		$this->template = new Google_Service_Fusiontables_Template_Resource ( $this, $this->serviceName, 'template', array (
				'methods' => array (
						'delete' => array (
...
class Google_Service_Fusiontables_Table_Resource extends Google_Service_Resource {
	...
	public function importRows($tableId, $optParams = array()) {
		...
		$params = array_merge ( $params, $optParams );
		return $this->call ( 'importRows', array (
				$params 
	...
	public function importTable($name, $optParams = array()) {
		...
		$params = array_merge ( $params, $optParams );
		return $this->call ( 'importTable', array (
				$params 
		), "Google_Service_Fusiontables_Table" );
	}
	/**
	 ...
	 * Unless explicitly requested, only the name,
