...
class Google_Service_PlusDomains extends Google_Service {
	...
	public function __construct(Google_Client $client) {
		...
		$this->activities = new Google_Service_PlusDomains_Activities_Resource ( $this, $this->serviceName, 'activities', array (
				'methods' => array (
						'get' => array (
		...
		$this->audiences = new Google_Service_PlusDomains_Audiences_Resource ( $this, $this->serviceName, 'audiences', array (
				'methods' => array (
						'list' => array (
		...
		$this->circles = new Google_Service_PlusDomains_Circles_Resource ( $this, $this->serviceName, 'circles', array (
				'methods' => array (
						'addPeople' => array (
		...
		$this->comments = new Google_Service_PlusDomains_Comments_Resource ( $this, $this->serviceName, 'comments', array (
				'methods' => array (
						'get' => array (
		...
		$this->media = new Google_Service_PlusDomains_Media_Resource ( $this, $this->serviceName, 'media', array (
				'methods' => array (
						'insert' => array (
		...
		$this->people = new Google_Service_PlusDomains_People_Resource ( $this, $this->serviceName, 'people', array (
				'methods' => array (
						'get' => array (
								'path' => 'people/{userId}',
								'httpMethod' => 'GET',
...
class Google_Service_PlusDomains_Circles_Resource extends Google_Service_Resource {
	 ...
	 * Google+ limits certain circle operations, including
	...
	public function addPeople($circleId, $optParams = array()) {
		...
		$params = array_merge ( $params, $optParams );
		return $this->call ( 'addPeople', array (
				$params 
	...
	public function removePeople($circleId, $optParams = array()) {
		...
		$params = array_merge ( $params, $optParams );
		return $this->call ( 'removePeople', array (
				$params 
		) );
	}
	/**
...
class Google_Service_PlusDomains_Media_Resource extends Google_Service_Resource {
	 ...
	 * The current upload size limitations are
...
class Google_Service_PlusDomains_People_Resource extends Google_Service_Resource {
	...
	public function listByActivity($activityId, $collection, $optParams = array()) {
		...
		$params = array_merge ( $params, $optParams );
		return $this->call ( 'listByActivity', array (
				$params 
		), "Google_Service_PlusDomains_PeopleFeed" );
	}
	/**
	...
	public function listByCircle($circleId, $optParams = array()) {
		...
		$params = array_merge ( $params, $optParams );
		return $this->call ( 'listByCircle', array (
				$params 
		), "Google_Service_PlusDomains_PeopleFeed" );
	}
}
