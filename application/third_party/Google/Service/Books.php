...
class Google_Service_Books extends Google_Service {
	...
	public function __construct(Google_Client $client) {
		...
		$this->bookshelves = new Google_Service_Books_Bookshelves_Resource ( $this, $this->serviceName, 'bookshelves', array (
				'methods' => array (
						'get' => array (
		...
		$this->bookshelves_volumes = new Google_Service_Books_BookshelvesVolumes_Resource ( $this, $this->serviceName, 'volumes', array (
				'methods' => array (
						'list' => array (
		...
		$this->cloudloading = new Google_Service_Books_Cloudloading_Resource ( $this, $this->serviceName, 'cloudloading', array (
				'methods' => array (
						'addBook' => array (
		...
		$this->layers = new Google_Service_Books_Layers_Resource ( $this, $this->serviceName, 'layers', array (
				'methods' => array (
						'get' => array (
		...
		$this->layers_annotationData = new Google_Service_Books_LayersAnnotationData_Resource ( $this, $this->serviceName, 'annotationData', array (
				'methods' => array (
						'get' => array (
		...
		$this->layers_volumeAnnotations = new Google_Service_Books_LayersVolumeAnnotations_Resource ( $this, $this->serviceName, 'volumeAnnotations', array (
				'methods' => array (
						'get' => array (
		...
		$this->myconfig = new Google_Service_Books_Myconfig_Resource ( $this, $this->serviceName, 'myconfig', array (
				'methods' => array (
		...
		$this->mylibrary_annotations = new Google_Service_Books_MylibraryAnnotations_Resource ( $this, $this->serviceName, 'annotations', array (
				'methods' => array (
						'delete' => array (
		...
		$this->mylibrary_bookshelves = new Google_Service_Books_MylibraryBookshelves_Resource ( $this, $this->serviceName, 'bookshelves', array (
				'methods' => array (
						'addVolume' => array (
		...
		$this->mylibrary_bookshelves_volumes = new Google_Service_Books_MylibraryBookshelvesVolumes_Resource ( $this, $this->serviceName, 'volumes', array (
				'methods' => array (
						'list' => array (
		...
		$this->mylibrary_readingpositions = new Google_Service_Books_MylibraryReadingpositions_Resource ( $this, $this->serviceName, 'readingpositions', array (
				'methods' => array (
						'get' => array (
		...
		$this->promooffer = new Google_Service_Books_Promooffer_Resource ( $this, $this->serviceName, 'promooffer', array (
				'methods' => array (
						'accept' => array (
		...
		$this->volumes = new Google_Service_Books_Volumes_Resource ( $this, $this->serviceName, 'volumes', array (
				'methods' => array (
						'get' => array (
		...
		$this->volumes_associated = new Google_Service_Books_VolumesAssociated_Resource ( $this, $this->serviceName, 'associated', array (
				'methods' => array (
						'list' => array (
		...
		$this->volumes_mybooks = new Google_Service_Books_VolumesMybooks_Resource ( $this, $this->serviceName, 'mybooks', array (
				'methods' => array (
						'list' => array (
		...
		$this->volumes_recommended = new Google_Service_Books_VolumesRecommended_Resource ( $this, $this->serviceName, 'recommended', array (
				'methods' => array (
						'list' => array (
		...
		$this->volumes_useruploaded = new Google_Service_Books_VolumesUseruploaded_Resource ( $this, $this->serviceName, 'useruploaded', array (
				'methods' => array (
						'list' => array (
...
class Google_Service_Books_Cloudloading_Resource extends Google_Service_Resource {
	...
	public function addBook($optParams = array()) {
		$params = array ();
		$params = array_merge ( $params, $optParams );
		return $this->call ( 'addBook', array (
				$params 
	...
	public function deleteBook($volumeId, $optParams = array()) {
		...
		$params = array_merge ( $params, $optParams );
		return $this->call ( 'deleteBook', array (
				$params 
		) );
	}
	/**
	...
	public function updateBook(Google_Service_Books_BooksCloudloadingResource $postBody, $optParams = array()) {
		...
		$params = array_merge ( $params, $optParams );
		return $this->call ( 'updateBook', array (
				$params 
		), "Google_Service_Books_BooksCloudloadingResource" );
	}
}
...
class Google_Service_Books_Myconfig_Resource extends Google_Service_Resource {
	...
	public function releaseDownloadAccess($volumeIds, $cpksver, $optParams = array()) {
		...
		$params = array_merge ( $params, $optParams );
		return $this->call ( 'releaseDownloadAccess', array (
				$params 
	...
	public function requestAccess($source, $volumeId, $nonce, $cpksver, $optParams = array()) {
		...
		$params = array_merge ( $params, $optParams );
		return $this->call ( 'requestAccess', array (
				$params 
	...
	public function syncVolumeLicenses($source, $nonce, $cpksver, $optParams = array()) {
		...
		$params = array_merge ( $params, $optParams );
		return $this->call ( 'syncVolumeLicenses', array (
				$params 
		), "Google_Service_Books_Volumes" );
	}
}
...
class Google_Service_Books_MylibraryAnnotations_Resource extends Google_Service_Resource {
	...
	public function summary($layerIds, $volumeId, $optParams = array()) {
		...
		$params = array_merge ( $params, $optParams );
		return $this->call ( 'summary', array (
				$params 
...
class Google_Service_Books_MylibraryBookshelves_Resource extends Google_Service_Resource {
	...
	public function addVolume($shelf, $volumeId, $optParams = array()) {
		...
		$params = array_merge ( $params, $optParams );
		return $this->call ( 'addVolume', array (
				$params 
		) );
	}
	/**
	...
	public function clearVolumes($shelf, $optParams = array()) {
		...
		$params = array_merge ( $params, $optParams );
		return $this->call ( 'clearVolumes', array (
				$params 
		) );
	}
	/**
	...
	public function moveVolume($shelf, $volumeId, $volumePosition, $optParams = array()) {
		...
		$params = array_merge ( $params, $optParams );
		return $this->call ( 'moveVolume', array (
				$params 
		) );
	}
	/**
	...
	public function removeVolume($shelf, $volumeId, $optParams = array()) {
		...
		$params = array_merge ( $params, $optParams );
		return $this->call ( 'removeVolume', array (
				$params 
		) );
	}
}
...
class Google_Service_Books_MylibraryReadingpositions_Resource extends Google_Service_Resource {
	...
	public function setPosition($volumeId, $timestamp, $position, $optParams = array()) {
		...
		$params = array_merge ( $params, $optParams );
		return $this->call ( 'setPosition', array (
				$params 
		) );
	}
}
...
class Google_Service_Books_VolumesAssociated_Resource extends Google_Service_Resource {
	 ...
	 * (associated.listVolumesAssociated)
	 *
	 * @param string $volumeId
