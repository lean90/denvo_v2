...
class Google_Service_Mirror extends Google_Service {
	...
	public function __construct(Google_Client $client) {
		...
		$this->accounts = new Google_Service_Mirror_Accounts_Resource ( $this, $this->serviceName, 'accounts', array (
				'methods' => array (
						'insert' => array (
		...
		$this->contacts = new Google_Service_Mirror_Contacts_Resource ( $this, $this->serviceName, 'contacts', array (
				'methods' => array (
						'delete' => array (
								'path' => 'contacts/{id}',
								'httpMethod' => 'DELETE',
		...
		$this->locations = new Google_Service_Mirror_Locations_Resource ( $this, $this->serviceName, 'locations', array (
				'methods' => array (
						'get' => array (
								'path' => 'locations/{id}',
								'httpMethod' => 'GET',
		...
		$this->settings = new Google_Service_Mirror_Settings_Resource ( $this, $this->serviceName, 'settings', array (
				'methods' => array (
						'get' => array (
								'path' => 'settings/{id}',
								'httpMethod' => 'GET',
		...
		$this->subscriptions = new Google_Service_Mirror_Subscriptions_Resource ( $this, $this->serviceName, 'subscriptions', array (
				'methods' => array (
						'delete' => array (
		...
		$this->timeline = new Google_Service_Mirror_Timeline_Resource ( $this, $this->serviceName, 'timeline', array (
				'methods' => array (
						'delete' => array (
								'path' => 'timeline/{id}',
								'httpMethod' => 'DELETE',
		...
		$this->timeline_attachments = new Google_Service_Mirror_TimelineAttachments_Resource ( $this, $this->serviceName, 'attachments', array (
				'methods' => array (
						'delete' => array (
