...
class Google_Service_Pubsub extends Google_Service {
	...
	public function __construct(Google_Client $client) {
		...
		$this->subscriptions = new Google_Service_Pubsub_Subscriptions_Resource ( $this, $this->serviceName, 'subscriptions', array (
				'methods' => array (
						'acknowledge' => array (
		...
		$this->topics = new Google_Service_Pubsub_Topics_Resource ( $this, $this->serviceName, 'topics', array (
				'methods' => array (
						'create' => array (
								'path' => 'topics',
								'httpMethod' => 'POST',
...
class Google_Service_Pubsub_Subscriptions_Resource extends Google_Service_Resource {
	 ...
	 * given message from the subscription.
	 * Acknowledging a message whose Ack
	...
	public function acknowledge(Google_Service_Pubsub_AcknowledgeRequest $postBody, $optParams = array()) {
		...
		return $this->call ( 'acknowledge', array (
				$params 
		) );
	}
	/**
	 ...
	 * All pending messages in the subscription
	...
	public function modifyAckDeadline(Google_Service_Pubsub_ModifyAckDeadlineRequest $postBody, $optParams = array()) {
		...
		$params = array_merge ( $params, $optParams );
		return $this->call ( 'modifyAckDeadline', array (
				$params 
		) );
	}
	/**
	...
	public function modifyPushConfig(Google_Service_Pubsub_ModifyPushConfigRequest $postBody, $optParams = array()) {
		...
		$params = array_merge ( $params, $optParams );
		return $this->call ( 'modifyPushConfig', array (
				$params 
		) );
	}
	/**
	 * Pulls a single message from the server.
	 * If return_immediately is true, and no
...
class Google_Service_Pubsub_Topics_Resource extends Google_Service_Resource {
	 ...
	 * All subscriptions to this topic are
	 ...
	 * Since the topic only has the name
