...
class Google_Service_Bigquery extends Google_Service {
	...
	public function __construct(Google_Client $client) {
		...
		$this->jobs = new Google_Service_Bigquery_Jobs_Resource ( $this, $this->serviceName, 'jobs', array (
				'methods' => array (
						'get' => array (
		...
		$this->projects = new Google_Service_Bigquery_Projects_Resource ( $this, $this->serviceName, 'projects', array (
				'methods' => array (
						'list' => array (
								'path' => 'projects',
								'httpMethod' => 'GET',
		...
		$this->tabledata = new Google_Service_Bigquery_Tabledata_Resource ( $this, $this->serviceName, 'tabledata', array (
				'methods' => array (
						'insertAll' => array (
		...
		$this->tables = new Google_Service_Bigquery_Tables_Resource ( $this, $this->serviceName, 'tables', array (
				'methods' => array (
						'delete' => array (
...
class Google_Service_Bigquery_Datasets_Resource extends Google_Service_Resource {
	 ...
	 * The update method replaces the
...
class Google_Service_Bigquery_Jobs_Resource extends Google_Service_Resource {
	...
	public function getQueryResults($projectId, $jobId, $optParams = array()) {
		...
		$params = array_merge ( $params, $optParams );
		return $this->call ( 'getQueryResults', array (
				$params 
...
class Google_Service_Bigquery_Tabledata_Resource extends Google_Service_Resource {
	...
	public function insertAll($projectId, $datasetId, $tableId, Google_Service_Bigquery_TableDataInsertAllRequest $postBody, $optParams = array()) {
		...
		$params = array_merge ( $params, $optParams );
		return $this->call ( 'insertAll', array (
				$params 
