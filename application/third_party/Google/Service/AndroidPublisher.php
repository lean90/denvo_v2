...
class Google_Service_AndroidPublisher extends Google_Service {
	...
	public function __construct(Google_Client $client) {
		...
		$this->edits = new Google_Service_AndroidPublisher_Edits_Resource ( $this, $this->serviceName, 'edits', array (
				'methods' => array (
						'commit' => array (
		...
		$this->edits_apklistings = new Google_Service_AndroidPublisher_EditsApklistings_Resource ( $this, $this->serviceName, 'apklistings', array (
				'methods' => array (
						'delete' => array (
		...
		$this->edits_apks = new Google_Service_AndroidPublisher_EditsApks_Resource ( $this, $this->serviceName, 'apks', array (
				'methods' => array (
						'list' => array (
		...
		$this->edits_details = new Google_Service_AndroidPublisher_EditsDetails_Resource ( $this, $this->serviceName, 'details', array (
				'methods' => array (
						'get' => array (
		...
		$this->edits_expansionfiles = new Google_Service_AndroidPublisher_EditsExpansionfiles_Resource ( $this, $this->serviceName, 'expansionfiles', array (
				'methods' => array (
						'get' => array (
		...
		$this->edits_images = new Google_Service_AndroidPublisher_EditsImages_Resource ( $this, $this->serviceName, 'images', array (
				'methods' => array (
						'delete' => array (
		...
		$this->edits_listings = new Google_Service_AndroidPublisher_EditsListings_Resource ( $this, $this->serviceName, 'listings', array (
				'methods' => array (
						'delete' => array (
		...
		$this->edits_testers = new Google_Service_AndroidPublisher_EditsTesters_Resource ( $this, $this->serviceName, 'testers', array (
				'methods' => array (
						'get' => array (
		...
		$this->edits_tracks = new Google_Service_AndroidPublisher_EditsTracks_Resource ( $this, $this->serviceName, 'tracks', array (
				'methods' => array (
						'get' => array (
		...
		$this->inappproducts = new Google_Service_AndroidPublisher_Inappproducts_Resource ( $this, $this->serviceName, 'inappproducts', array (
				'methods' => array (
						'batch' => array (
		...
		$this->purchases_products = new Google_Service_AndroidPublisher_PurchasesProducts_Resource ( $this, $this->serviceName, 'products', array (
				'methods' => array (
						'get' => array (
		...
		$this->purchases_subscriptions = new Google_Service_AndroidPublisher_PurchasesSubscriptions_Resource ( $this, $this->serviceName, 'subscriptions', array (
				'methods' => array (
						'cancel' => array (
...
class Google_Service_AndroidPublisher_Edits_Resource extends Google_Service_Resource {
	...
	public function commit($packageName, $editId, $optParams = array()) {
		...
		return $this->call ( 'commit', array (
				$params 
		), "Google_Service_AndroidPublisher_AppEdit" );
	}
	/**
	 * Deletes an edit for an app.
	 * Creating a new edit will automatically delete any
	 ...
	 * Calls will fail if the edit is
...
class Google_Service_AndroidPublisher_EditsApklistings_Resource extends Google_Service_Resource {
	...
	public function deleteall($packageName, $editId, $apkVersionCode, $optParams = array()) {
		...
		$params = array_merge ( $params, $optParams );
		return $this->call ( 'deleteall', array (
				$params 
		) );
	}
	/**
...
class Google_Service_AndroidPublisher_EditsDetails_Resource extends Google_Service_Resource {
	 ...
	 * This includes the default language and
...
class Google_Service_AndroidPublisher_EditsExpansionfiles_Resource extends Google_Service_Resource {
	 ...
	 * Expansion Files.
	 * To add a new Expansion File use the Upload method. This
...
class Google_Service_AndroidPublisher_PurchasesSubscriptions_Resource extends Google_Service_Resource {
	 ...
	 * The subscription remains valid until
