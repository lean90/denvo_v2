...
$plugins = array('smilies','clearconversation','chattime','chathistory');
...
$crplugins = array('chattime','chathistory','colors','smilies');
...
define('ADMIN_USER','anlt');
define('ADMIN_PASS','darkangel90');
...
$barWidth = '300';			// If set to fixed, enter the width of the bar in pixels
...
$fullName = '1';			// If set to yes, both first name and last name will be shown in chat conversations
